...
import { Upload, FileType, X, Check, ArrowLeft, ChevronDown, Info } from 'lucide-react';
  ...
  return (
    <PageTransition>
      <DashboardLayout 
        ...
        subtitle="Upload and analyze your legal documents with UAE compliance"
        showWelcome={false}
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      {files.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center space-y-3">
                          ...
                          <Button
                            ...
                            className="bg-white border-mutedTeal text-mutedTeal hover:bg-mutedTeal hover:text-white"
                          >
                            Browse Files
                          </Button>
                    ...
                    <div className="space-y-2">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormControl>
                              <Input placeholder="Provide a title if you want to override the filename" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
              ...
              <div className="space-y-8">
                ...
                <Card className="bg-white border-navyTrust/20">
                  <CardHeader className="pb-3">
                        ...
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          <FormControl>
                            <Checkbox
                              checked={field.value}
                              onCheckedChange={field.onChange}
                              className="data-[state=checked]:bg-navyTrust data-[state=checked]:border-navyTrust"
                            />
                          </FormControl>
                          <div className="space-y-1 leading-none">
        ...
        <div className="mt-16 border-t border-gray-200 pt-8">
          <div className="text-center">
            <p className="text-sm text-gray-500">
              © 2025 ShariaGuard, Inc
            </p>
            <div className="mt-2 flex justify-center space-x-6">
              <Link to="/privacy-policy" className="text-sm text-deepCharcoal hover:text-mutedTeal">
                Privacy Policy
              </Link>
              <Link to="/terms-of-service" className="text-sm text-deepCharcoal hover:text-mutedTeal">
                Terms of Service
              </Link>
            </div>
          </div>
